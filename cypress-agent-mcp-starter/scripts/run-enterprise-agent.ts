...
import { EnterpriseAgent, EnterpriseGenerationRequest } from '../cypress/support/agents/enterprise.agent';

const inputPath = process.argv[2] ?? 'agent_maps/enterprise-sample.json';
