...
export function analyzeFailure(
  ...
  const likelyRootCause = likelyServerError
    ...
    : 'No server-side error matched the failure. Review client-side evidence and trace.';
  ...
  return {
    ...
    alertPayloads: [
      {
        channel: 'slack',
        title: `Failure RCA: ${evidence.testName}`,
        body,
      },
      {
        channel: 'jira',
        title: `[Auto] ${evidence.testName} root cause`,
        body,
      },
    ],
  };
